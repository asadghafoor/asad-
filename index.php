        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><h3 style="color: white;">Ansar Hospital</h3></a>
            </div>
        ...
        <div class="row">
          <div class="banner-info">
            <div class="banner-logo text-center">
              <h1 style="color: white;">Ansar Hospital</h1>
            </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="img/aziz.jpg" alt="..." class="team-img">
            <div class="caption">
              <h3>Jessica Wally</h3>
              <p>Doctor</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="img/asad.jpg" alt="..." class="team-img">
            <div class="caption">
              <h3>Assadullah</h3>
              <p>Doctor</p>
              <ul class="list-inline">
                <li><a href="https://www.facebook.com/profile.php?id=100010968189475"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
              </ul>
            </div>
    ...
    <div class="container">
      <div class=" row">
        ...
        <div class="col-md-4 col-sm-5">
          ...
          <p class="text-right text-primary"><i>— Ansar Hospital</i></p>
        </div>
        <div class="col-md-2"></div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Civil Hospital<br> Nasirabad, Qamber</p>
          <div class="space"></div>
          <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i><a href="mailto:asadullahchhutto497@gmail.com">asadullahchhutto497@gmail.com</a></p>
          <div class="space"></div>
          <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+923042391593</p>
        </div>
...
?>
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            ...
            <form action="/Hospital/index.php" method="post">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="desc" id="desc" cols="30" rows="10" placeholder="message"></textarea> 
    </div>
    
    <button type="submit" class="btn btn-primary">Submit</button>
    <button type="submit" class="btn btn-primary"><a href="display.php" style="color: white; text-decoration: none;">Check</a></button>
    </form>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <div class="credits">
              ...
              -->
              Designed by <a href="#">Assadullah</a>
            </div>
          </div>
        </div>
      </div>
